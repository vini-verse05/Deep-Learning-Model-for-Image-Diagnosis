...
# In production: store in environment variable, NOT in code!
SECRET_KEY = b'MedicalAISecureK3y_32BytesLong!!'  # Exactly 32 bytes

assert len(SECRET_KEY) == 32, 'AES-256 requires exactly 32 bytes!'
...
def encrypt_image(input_path, encrypted_filename=None):
    ...
    output_path = os.path.join('encrypted_images', encrypted_filename)
